...
<body>
<div id="main" style="width:100%;height:100vh;z-index:-1"></div>
<button id="turnPage" style="position:fixed;right:50px;top:50%;width:100px;height:30px;z-index:1;">决策系统</button>
<script type="text/javascript">
    // 页面跳转
    ...
    var optionMap = {
        ...
        visualMap: {
            ...
            y: 'center',
            splitList: [
                {start: 450, end: 600}, {start: 300, end: 450},
                {start: 150, end: 300}, {start: 0, end: 150},
            ],
            color: ['#4F7FE8', '#6892ED', '#97B7FC', '#BED0F7'],
            seriesIndex: 0
        },
